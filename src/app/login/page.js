...
export default function Login() {
  ...
  return (
    <main className="flex min-h-[calc(100vh-10rem)] items-center justify-center bg-gray-400 dark:bg-gray-900">
      <div className="w-full max-w-sm rounded-2xl border border-gray-100 bg-white/70 p-8 shadow-sm backdrop-blur dark:border-gray-700 dark:bg-gray-800/70">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          {error && (
            <p
              className="rounded-md border border-red-300 bg-red-50 px-3 py-2 text-xs font-medium text-red-700 dark:border-red-600/40 dark:bg-red-900/30 dark:text-red-300"
              aria-live="assertive"
            >
              {error}
            </p>
